  ...
  subroutine mhm_read_config(file_namelist, unamelist)
    ...
    if (optimize) then
      select case (opti_function)
        ...
        case(27, 29, 30, 44, 51 : 56)
          ! evapotranspiration
          print*, 'Optional data loaded: ET'
          call position_nml('optional_data', unamelist)
          read(unamelist, nml = optional_data)
          do iDomain = 1, domainMeta%nDomains
            domainID = domainMeta%indices(iDomain)
        ...
        case(15, 43, 58)
          ...
          print*, 'Optional data loaded: TWSA'
          call position_nml('optional_data', unamelist)
          read(unamelist, nml = optional_data)
          do iDomain = 1, domainMeta%nDomains
            domainID = domainMeta%indices(iDomain)
        ...
        !Read ET and SM !added by Moctar Dembélé, 11.01.2019
        !Updated for mHM v5.12.1 by Loïc Gerber, 12.12.2022
        case(46)
          print*, 'Optional data loaded: ET + SM'
          ! evapotranspiration
          call position_nml('optional_data', unamelist)
          read(unamelist, nml = optional_data)
          do iDomain = 1, domainMeta%nDomains
        ...
        !Read ET and TWS !added by Moctar Dembélé, 11.01.2019
        !Updated for mHM v5.12.1 by Loïc Gerber, 12.12.2022
        case(40, 47)
          print*, 'Optional data loaded: ET + TWSA'
          ! evapotranspiration
          call position_nml('optional_data', unamelist)
          read(unamelist, nml = optional_data)
          do iDomain = 1, domainMeta%nDomains
        ...
        !Read SM and TWS !added by Moctar Dembélé, 11.01.2019
        !Updated for mHM v5.12.1 by Loïc Gerber, 12.12.2022
        case(41, 48)
          print*, 'Optional data loaded: SM + TWSA'
          ! soil moisture
          call position_nml('optional_data', unamelist)
          read(unamelist, nml = optional_data)
          do iDomain = 1, domainMeta%nDomains
