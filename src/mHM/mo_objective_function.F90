...
CONTAINS
  ...
  FUNCTION objective(parameterset, eval, arg1, arg2, arg3)
    ...
    case (40) !added by Moctar Dembélé, 10.01.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [RMSE_TWS**2 + SPEM_ET**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_rmse_tws_spem_et(parameterset, eval)
    case (41) !added by Moctar Dembélé, 10.01.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [RMSE_TWS**2 + SPEM_SM**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_rmse_tws_spem_sm(parameterset, eval)
    case (42) !added by Moctar Dembélé, 10.01.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [RMSE_TWS**2 + SPEM_ET**2 + SPEM_SM**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_rmse_tws_spem_et_sm(parameterset, eval)
    case (43) !added by Moctar Dembélé, 10.01.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [power2_NSE_lnNSE_Q**2 + RMSE_TWS**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_nse_lnnse_q_rmse_tws(parameterset, eval)
    case (44) !added by Moctar Dembélé, 10.01.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [power2_NSE_lnNSE_Q**2 + SPEM_ET**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_nse_lnnse_q_spem_et(parameterset, eval)
    case (45) !added by Moctar Dembélé, 10.01.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [power2_NSE_lnNSE_Q**2 + SPEM_SM**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_nse_lnnse_q_spem_sm(parameterset, eval)
    case (46) !added by Moctar Dembélé, 10.01.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [power2_NSE_lnNSE_Q**2 + SPEM_ET**2 + SPEM_SM**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_nse_lnnse_q_spem_et_sm(parameterset, eval)
    case (47) !added by Moctar Dembélé, 10.01.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [power2_NSE_lnNSE_Q**2 + RMSE_TWS**2 + SPEM_ET**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_nse_lnnse_q_rmse_tws_spem_et(parameterset, eval)
    case (48) !added by Moctar Dembélé, 10.01.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [power2_NSE_lnNSE_Q**2 + RMSE_TWS**2 + SPEM_SM**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_nse_lnnse_q_rmse_tws_spem_sm(parameterset, eval)
    case (49) !added by Moctar Dembélé, 07.01.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [power2_NSE_lnNSE_Q**2 + RMSE_TWS**2 + SPEM_ET**2 + SPEM_SM**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_nse_lnnse_q_rmse_tws_spem_et_sm(parameterset, eval)
    case (50) !added by Moctar Dembélé, 24.12.2018 - adapted by Loïc Gerber, 12.2022
      !OF = [KGE_Q**2 + RMSE_TWS**2 + SPEM_ET**2 + SPEM_SM**2]**(1/2), changed to power2, 07.03.2019
      objective = objective_kge_q_rmse_tws_spem_et_sm(parameterset, eval)
    case (51) !added by Moctar Dembélé, 26.04.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [KGE_Q**2 KGE_ET_catch_avg**2]**(1/2)
      objective = objective_kge_q_kge_et_catchment_avg(parameterset, eval)
    case (52) !added by Moctar Dembélé, 26.04.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [KGE_Q**2 KGE_ET**2]**(1/2) !spatial KGE on ET at each time step
      objective = objective_kge_q_spaceKGE_et(parameterset, eval)
    case (53) !added by Moctar Dembélé, 26.04.2019 - adapted by Loïc Gerber, 12.2022
      !OF = [KGE_Q**2 SPEM_ET**2]**(1/2)
      objective = objective_kge_q_spem_et(parameterset, eval)
    case (54) !added by Moctar Dembélé, 26.04.2019 - adapted by Loïc Gerber, 12.2022
      !OF = KGE(ET), !KGE for each pixel, and average KGE of all pixel
      objective = objective_timeKGE_et(parameterset, eval)
    case (55) !added by Moctar Dembélé, 26.04.2019 - adapted by Loïc Gerber, 12.2022
      !OF = KGE(ET), !KGE at each time step over all pixels, and average KGE of all time steps
      objective = objective_spaceKGE_et(parameterset, eval)
    case (56) !added by Moctar Dembélé, 10.01.2019 - adapted by Loïc Gerber, 12.2022
      objective = objective_spem_et(parameterset, eval)
    case (57) !added by Loïc Gerber, 12.2022
      objective = objective_spem_sm(parameterset, eval)
    case (58) !added by Loïc Gerber, 01.2023
      objective = objective_spem_twsa(parameterset, eval)
    case (59) !added by Loïc Gerber, 01.2023
      !OF = [power2_NSE_lnNSE_Q**2 + SPEM_TWSA**2 + SPEM_ET**2 + SPEM_SM**2]**(1/2)
      objective = objective_nse_lnnse_q_spem_twsa_et_sm(parameterset, eval)
  ...
  FUNCTION objective_master(parameterset, eval, arg1, arg2, arg3)
    ...
    case(40) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_rmse_tws_spem_et = ', num2str(objective_master, '(F9.5)'))
    case(41) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_rmse_tws_spem_sm = ', num2str(objective_master, '(F9.5)'))
    case(42) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_rmse_tws_spem_et_sm = ', num2str(objective_master, '(F9.5)'))
    case(43) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_nse_lnnse_q_rmse_tws = ', num2str(objective_master, '(F9.5)'))
    case(44) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_nse_lnnse_q_spem_et = ', num2str(objective_master, '(F9.5)'))
    case(45) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_nse_lnnse_q_spem_sm = ', num2str(objective_master, '(F9.5)'))
    case(46) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_nse_lnnse_q_spem_et_sm = ', num2str(objective_master, '(F9.5)'))
    case(47) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_nse_lnnse_q_rmse_tws_spem_et = ', num2str(objective_master, '(F9.5)'))
    case(48) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_nse_lnnse_q_rmse_tws_spem_sm = ', num2str(objective_master, '(F9.5)'))
    case(49) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_nse_lnnse_q_rmse_tws_spem_et_sm = ', num2str(objective_master, '(F9.5)'))
    case(50) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_kge_q_rmse_tws_spem_et_sm = ', num2str(objective_master, '(F9.5)'))
    case(51) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_kge_q_kge_et_catchment_avg = ', num2str(objective_master, '(F9.5)'))
    case(52) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_kge_q_spaceKGE_et = ', num2str(objective_master, '(F9.5)'))
    case(53) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_kge_q_spem_et = ', num2str(objective_master, '(F9.5)'))
    case(54) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_timeKGE_et = ', num2str(objective_master, '(F9.5)'))
    case(55) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_spaceKGE_et = ', num2str(objective_master, '(F9.5)'))
    case(56) ! Added by Loïc Gerber 12.2022 after Dembélé 2019
      call message('    objective_spem_et = ', num2str(objective_master, '(F9.5)'))
    case(57) ! Added by Loïc Gerber 01.2023
      call message('    objective_spem_sm = ', num2str(objective_master, '(F9.5)'))
    case(58) ! Added by Loïc Gerber 01.2023
      call message('    objective_spem_twsa = ', num2str(objective_master, '(F9.5)'))
    case(59) ! Added by Loïc Gerber 01.2023
  ...
  subroutine objective_subprocess(eval, arg1, arg2, arg3)
    ...
    do ! a do loop without condition runs until exit
      ...
      case(40) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_rmse_tws_spem_et(parameterset, eval)
      case(41) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_rmse_tws_spem_sm(parameterset, eval)
      case(42) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_rmse_tws_spem_et_sm(parameterset, eval)
      case(43) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_nse_lnnse_q_rmse_tws(parameterset, eval)
      case(44) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_nse_lnnse_q_spem_et(parameterset, eval)
      case(45) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_nse_lnnse_q_spem_sm(parameterset, eval)
      case(46) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_nse_lnnse_q_spem_et_sm(parameterset, eval)
      case(47) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_nse_lnnse_q_rmse_tws_spem_et(parameterset, eval)
      case(48) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_nse_lnnse_q_rmse_tws_spem_sm(parameterset, eval)
      case(49) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_nse_lnnse_q_rmse_tws_spem_et_sm(parameterset, eval)
      case(50) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_kge_q_rmse_tws_spem_et_sm(parameterset, eval)
      case(51) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_kge_q_kge_et_catchment_avg(parameterset, eval)
      case(52) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_kge_q_spaceKGE_et(parameterset, eval)
      case(53) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_kge_q_spem_et(parameterset, eval)
      case(54) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_timeKGE_et(parameterset, eval)
      case(55) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_spaceKGE_et(parameterset, eval)
      case(56) !Added by Loïc Gerber 12.2022 after Dembélé
        partial_objective = objective_spem_et(parameterset, eval)
      case(57) !Added by Loïc Gerber 01.2023
        partial_objective = objective_spem_sm(parameterset, eval)
      case(58) !Added by Loïc Gerber 01.2023
        partial_objective = objective_spem_twsa(parameterset, eval)
      case(59) !Added by Loïc Gerber 01.2023
  ...
  !    NAME
  !        objective_rmse_tws_spem_et 

  !    PURPOSE
  !>       \brief Objective function evapotranspiration and terrestrial water storage (tws).
			!OF = [RMSE_TWS**2 + SPEM_ET**2]**(1/2)

  !>       \details ...TO BE COMPLETED.
  !>       \it is assumed that optional data for optimization are monthly data.
  
  ! added by Moctar Dembélé, 10.01.2019
  ! updated for mHM v5.12.1 by Loïc Gerber, 12.2022
  
  FUNCTION objective_rmse_tws_spem_et(parameterset, eval)
    ...
    real(dp) :: objective_rmse_tws_spem_et 
	
    real(dp) :: objective_spem_et
    real(dp) :: rmse_tws_avg
    real(dp) :: spem_et_avg
    ...
    ! simulated evapotranspiration and soil moisture
    type(optidata_sim), dimension(:), allocatable :: etOptiSim
	
    ! modelled tws for a given parameter set
    type(optidata_sim), dimension(:), allocatable :: twsOptiSim
    ...
    allocate(twsOptiSim(domainMeta%nDomains))
    allocate(etOptiSim (domainMeta%nDomains))
    call eval(parameterset, etOptiSim = etOptiSim, twsOptiSim = twsOptiSim)

    ! -------------------------------------------
    ! EVAPOTRANSPIRATION + TWS
    ! -------------------------------------------
    ...
    do iDomain = 1, domainMeta%nDomains
      ...
      !  EVAPOTRANSPIRATION
      ! --------------------
      ! rmse is calculated for every time step
      invalid_times = 0.0_dp
      ...
      nMonths_tws = size(tws_obs_mask)

      allocate(month_classes (nMonths_tws))
      allocate(tws_obs_m_anom(nMonths_tws))
      allocate(tws_sim_m_anom(nMonths_tws))
    ...
    !--------------------------------------------
    !! COMBINED OF FOR ET + TWS
    !--------------------------------------------
    ! compromise objective functions for evapotranspiration and tws
    ! OF = [RMSE(z-score_TWS_domain_avg)**2 + SPEM(ET)**2)]**(1/2)
    objective_rmse_tws_spem_et  = sqrt(rmse_tws_avg**2 + objective_spem_et**2)
	
    ! OF = [RMSE(z-score_TWS_domain_avg)**6 + SPEM(ET)**6)]**(1/6)
    !objective_rmse_tws_spem_et  = (rmse_tws_avg**6 + objective_spem_et**6)**onesixth
	
    call message('      objective_rmse_tws (i.e., RMSE) = ', num2str(rmse_tws_avg, '(F9.5)'))
    call message('   objective_spem_et (i.e., 1 - SPEM) = ', num2str(objective_spem_et, '(F9.5)'))
    call message('     objective_final_rmse_tws_spem_et = ', num2str(objective_rmse_tws_spem_et, '(F9.5)'))

  END FUNCTION objective_rmse_tws_spem_et
  ...
  !    NAME
  !        objective_rmse_tws_spem_sm 

  !    PURPOSE
  !>       \brief Objective function soil moisture and terrestrial water storage (tws).
			!OF = [RMSE_TWS**2 + SPEM_SM**2]**(1/2)
  ...
  FUNCTION objective_rmse_tws_spem_sm(parameterset, eval)
    ...
    use mo_common_mhm_mrm_variables, only : evalPer
    use mo_errormeasures, only : rmse
    use mo_global_variables, only : L1_twsaObs, L1_smObs
    use mo_message, only : message
    use mo_string_utils, only : num2str
    use mo_julian, only : caldat
    use mo_moment, only : mean
    ...
    real(dp) :: objective_rmse_tws_spem_sm 
    ...
    !--------------------------------------------
    !! COMBINED OF FOR SM + TWS
    !--------------------------------------------
    ! compromise objective functions for soil moisture and tws
    ! OF = [RMSE(z-score_TWS_domain_avg)**2 + SPEM(SM)**2)]**(1/2)
    objective_rmse_tws_spem_sm  = sqrt(rmse_tws_avg**2 + objective_spem_sm**2)
	
    ! OF = [RMSE(z-score_TWS_domain_avg)**6 + SPEM(SM)**6)]**(1/6)
    !objective_rmse_tws_spem_sm  = (rmse_tws_avg**6 + objective_spem_sm**6)**onesixth
	
    call message('      objective_rmse_tws (i.e., RMSE) = ', num2str(rmse_tws_avg, '(F9.5)'))
    call message('   objective_spem_sm (i.e., 1 - SPEM) = ', num2str(objective_spem_sm, '(F9.5)'))
    call message('     objective_final_rmse_tws_spem_sm = ', num2str(objective_rmse_tws_spem_sm, '(F9.5)'))

  END FUNCTION objective_rmse_tws_spem_sm
  ...
  !    NAME
  !        objective_rmse_tws_spem_et_sm 

  !    PURPOSE
  !>       \brief Objective function evapotranspiration, soil moisture
            ! and terrestrial water storage (tws).
			!OF = [RMSE_TWS**2 + SPEM_ET**2 + SPEM_SM**2]**(1/2)
  ...
  FUNCTION objective_rmse_tws_spem_et_sm(parameterset, eval)
    ...
    use mo_common_mhm_mrm_variables, only : evalPer
    use mo_errormeasures, only : rmse
    use mo_global_variables, only : L1_twsaObs, L1_etObs, L1_smObs
    use mo_message, only : message
    use mo_string_utils, only : num2str
    use mo_julian, only : caldat
    use mo_moment, only : mean
    ...
    real(dp) :: objective_rmse_tws_spem_et_sm 
    ...
    ! -------------------------------------------
    ! EVAPOTRANSPIRATION + SOIL MOISTURE + TWS
    ! -------------------------------------------
    ...
    !--------------------------------------------
    !! COMBINED OF FOR SM + ET + TWS
    !--------------------------------------------
    ! compromise objective functions for evapotranspiration, soil moisture and tws
    ! OF = [RMSE(z-score_TWS_domain_avg)**2 + SPEM(ET)**2 + SPEM(SM)**2)]**(1/2)
    objective_rmse_tws_spem_et_sm  = sqrt(rmse_tws_avg**2 + & 
                                                objective_spem_et**2 + objective_spem_sm**2)
												
    ! OF = [RMSE(z-score_TWS_domain_avg)**6 + SPEM(ET)**6 + SPEM(SM)**6)]**(1/6)
    !objective_rmse_tws_spem_et_sm  = (rmse_tws_avg**6 + & 
    !                                            objective_spem_et**6 + objective_spem_sm**6)**onesixth
												
    call message('       objective_rmse_tws (i.e., RMSE) = ', num2str(rmse_tws_avg, '(F9.5)'))
    call message('    objective_spem_et (i.e., 1 - SPEM) = ', num2str(objective_spem_et, '(F9.5)'))
    call message('    objective_spem_sm (i.e., 1 - SPEM) = ', num2str(objective_spem_sm, '(F9.5)'))
    call message('   objective_final_rmse_tws_spem_et_sm = ', num2str(objective_rmse_tws_spem_et_sm, '(F9.5)'))

  END FUNCTION objective_rmse_tws_spem_et_sm
 ...
 ! -----------------------------------------------------------------
  ...
  !    NAME
  !        objective_nse_lnnse_q_rmse_tws 

  !    PURPOSE
  !>       \brief Objective function for Q, evapotranspiration and terrestrial water storage (tws).
			!OF = sqrt(power2_nse_lnnse(Q)**2 + RMSE(z-score_TWS_domain_avg)**2) 
  ...
  FUNCTION objective_nse_lnnse_q_rmse_tws(parameterset, eval)
    ...
    use mo_common_constants, only : eps_dp, nodata_dp
    use mo_common_mhm_mrm_variables, only : evalPer
    use mo_errormeasures, only : lnnse, nse, rmse
    use mo_message, only : message
    use mo_string_utils, only : num2str
    use mo_julian, only : caldat
    use mo_moment, only : mean
    ...
    real(dp) :: objective_nse_lnnse_q_rmse_tws 
    ...
    ! power2_nse_lnnse(nGaugesTotal)
    real(dp), dimension(:), allocatable :: power2_nse_lnnse
	
    real(dp) :: power2_nse_lnnse_avg
    ...
    do iDomain = 1, domainMeta%nDomains
      ...
      ! check for potentially 2 years of data
      if (count(tws_obs_mask) .lt.  12 * 2) then
        call message('objective_nse_lnnse_q_rmse_tws: Length of TWS data of domain ', trim(adjustl(num2str(domainID))), &
                ' less than 2 years: this is not recommended')
      end if
    ...
    ! -----------------------------
    objective_q = 0.0_dp
    power2_nse_lnnse_avg = 0_dp

    nGaugesTotal = size(runoff, dim = 2)
    allocate(power2_nse_lnnse(nGaugesTotal))
    power2_nse_lnnse(:) = nodata_dp
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_nse_lnnse_q_rmse_tws : Length of TWS data of domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
	  
      ! calculate NSE + lnNSE for each domain:
      power2_nse_lnnse(gg) = sqrt((1.0_dp - nse(runoff_obs, runoff_agg, mask = runoff_obs_mask))**2 + &
                      (1.0_dp - lnnse(runoff_obs, runoff_agg, mask = runoff_obs_mask))**2)
      deallocate(runoff_agg, runoff_obs, runoff_obs_mask)

    end do
	
    ! calculate average NSE + lnNSE value for runoff
    power2_nse_lnnse_avg = sum(power2_nse_lnnse(:), abs(power2_nse_lnnse - nodata_dp) .gt. eps_dp) / &
            real(count(abs(power2_nse_lnnse - nodata_dp) .gt. eps_dp), dp)
    deallocate(power2_nse_lnnse)

    ! objective nse+lnNSE Q
    objective_q = power2_nse_lnnse_avg

    !--------------------------------------------
    !! COMBINED OF FOR Q + TWS
    !--------------------------------------------
    ! compromise objective functions for discharge and tws
    ! OF = sqrt(power2_nse_lnnse(Q)**2 + RMSE(z-score_TWS_domain_avg)**2)
    objective_nse_lnnse_q_rmse_tws  = sqrt(objective_q**2 + rmse_tws_avg**2)
	
    ! OF = sqrt(power2_nse_lnnse(Q)**2 + RMSE(z-score_TWS_domain_avg)**2)
    !objective_nse_lnnse_q_rmse_tws  = (objective_q**6 + rmse_tws_avg**6)**onesixth
	
    call message('    objective_nse_lnnse_q (i.e., power2_nse_lnnse) = ', num2str(objective_q, '(F9.5)'))
    call message('                   objective_rmse_tws (i.e., RMSE) = ', num2str(rmse_tws_avg, '(F9.5)'))
    call message('              objective_final_nse_lnnse_q_rmse_tws = ', & 
                                                 num2str(objective_nse_lnnse_q_rmse_tws, '(F9.5)'))

  END FUNCTION objective_nse_lnnse_q_rmse_tws
 ...
 ! -----------------------------------------------------------------
  ...
  !    NAME
  !        objective_nse_lnnse_q_spem_et 

  !    PURPOSE
  !>       \brief Objective function for Q and evapotranspiration
			!OF = sqrt(power2_nse_lnnse(Q)**2 + SPEM(ET)**2) 
  ...
  FUNCTION objective_nse_lnnse_q_spem_et(parameterset, eval)
    ...
    real(dp) :: objective_nse_lnnse_q_spem_et 
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_nse_lnnse_q_spem_et : Length of Q data of Domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    !--------------------------------------------
    !! COMBINED OF FOR Q + ET
    !--------------------------------------------
    ! compromise objective functions for discharge and evapotranspiration
    ! OF = sqrt(power2_nse_lnnse(Q)**2 + SPEM(ET)**2)
    objective_nse_lnnse_q_spem_et  = sqrt(objective_q**2 + objective_spem_et**2)
	
    ! OF = (power2_nse_lnnse(Q)**6 + SPEM(ET)**6)**onesixth
    !objective_nse_lnnse_q_spem_et  = (objective_q**6 + objective_spem_et**6)**onesixth
	
    call message('   objective_nse_lnnse_q (i.e., power2_nse_lnnse) = ', num2str(objective_q, '(F9.5)'))
    call message('               objective_spem_et (i.e., 1 - SPEM) = ', num2str(objective_spem_et, '(F9.5)'))
    call message('              objective_final_nse_lnnse_q_spem_et = ', & 
                                                 num2str(objective_nse_lnnse_q_spem_et, '(F9.5)'))

  END FUNCTION objective_nse_lnnse_q_spem_et
...
! -----------------------------------------------------------------
  ...
  !    NAME
  !        objective_nse_lnnse_q_spem_sm 

  !    PURPOSE
  !>       \brief Objective function for Q and soil moisture
			!OF = sqrt(power2_nse_lnnse(Q)**2 + SPEM(SM)**2) 
  ...
  FUNCTION objective_nse_lnnse_q_spem_sm(parameterset, eval)
    ...
    real(dp) :: objective_nse_lnnse_q_spem_sm 
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_nse_lnnse_q_spem_sm : Length of Q data of Domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    !--------------------------------------------
    !! COMBINED OF FOR Q + SM
    !--------------------------------------------
    ! compromise objective functions for discharge and soil moisture
    ! OF = sqrt(power2_nse_lnnse(Q)**2 + SPEM(SM)**2)
    objective_nse_lnnse_q_spem_sm  = sqrt(objective_q**2 + objective_spem_sm**2)
	
    !objective_nse_lnnse_q_spem_sm  = (objective_q**6 + objective_spem_sm**6)**onesixth
	
    call message('   objective_nse_lnnse_q (i.e., power2_nse_lnnse) = ', num2str(objective_q, '(F9.5)'))
    call message('               objective_spem_sm (i.e., 1 - SPEM) = ', num2str(objective_spem_sm, '(F9.5)'))
    call message('              objective_final_nse_lnnse_q_spem_sm = ', & 
                                                 num2str(objective_nse_lnnse_q_spem_sm, '(F9.5)'))

  END FUNCTION objective_nse_lnnse_q_spem_sm
 

 ! -----------------------------------------------------------------

  !    NAME
  !        objective_nse_lnnse_q_spem_et_sm 

  !    PURPOSE
  !>       \brief Objective function for Q, evapotranspiration and soil moisture
			!OF = sqrt(power2_nse_lnnse(Q)**2 + SPEM(ET)**2 + SPEM(SM)**2) 
  ...
  FUNCTION objective_nse_lnnse_q_spem_et_sm(parameterset, eval)

    use mo_optimization_types, only : optidata_sim
    use mo_common_variables, only : level1, domainMeta
    use mo_common_constants, only : eps_dp, nodata_dp
    use mo_errormeasures, only : lnnse, nse
    use mo_global_variables, only : L1_etObs, L1_smObs
    use mo_message, only : message
    use mo_string_utils, only : num2str
    use mo_spem, only : spem
    use mo_mrm_objective_function_runoff, only : extract_runoff
    ...
    real(dp) :: objective_nse_lnnse_q_spem_et_sm 
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_nse_lnnse_q_spem_et_sm : Length of Q data of domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    !--------------------------------------------
    !! COMBINED OF FOR Q + SM + ET
    !--------------------------------------------
    ! compromise objective functions for discharge, evapotranspiration and soil moisture
    ! OF = sqrt(power2_nse_lnnse(Q)**2 + SPEM(ET)**2 + SPEM(SM)**2)
    objective_nse_lnnse_q_spem_et_sm  = sqrt(objective_q**2 + & 
                                                objective_spem_et**2 + objective_spem_sm**2)
												
    !objective_nse_lnnse_q_spem_et_sm  = (objective_q**6 + & 
    !                                            objective_spem_et**6 + objective_spem_sm**6)**onesixth
	
    call message('   objective_nse_lnnse_q (i.e., power2_nse_lnnse) = ', num2str(objective_q, '(F9.5)'))
    call message('               objective_spem_et (i.e., 1 - SPEM) = ', num2str(objective_spem_et, '(F9.5)'))
    call message('               objective_spem_sm (i.e., 1 - SPEM) = ', num2str(objective_spem_sm, '(F9.5)'))
    call message('           objective_final_nse_lnnse_q_spem_et_sm = ', & 
                                                 num2str(objective_nse_lnnse_q_spem_et_sm, '(F9.5)'))

  END FUNCTION objective_nse_lnnse_q_spem_et_sm
  ...
  !    NAME
  !        objective_nse_lnnse_q_rmse_tws_spem_et 

  !    PURPOSE
  !>       \brief Objective function for Q, evapotranspiration and terrestrial water storage (tws).
			!OF = sqrt(power2_nse_lnnse(Q)**2 + RMSE(z-score_TWS_domain_avg)**2 + SPEM(ET)**2) 
  ...
  FUNCTION objective_nse_lnnse_q_rmse_tws_spem_et(parameterset, eval)
    ...
    real(dp) :: objective_nse_lnnse_q_rmse_tws_spem_et 
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_nse_lnnse_q_rmse_tws_spem_et : Length of TWS data of domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    !--------------------------------------------
    !! COMBINED OF FOR Q + ET + TWS
    !--------------------------------------------
    ! compromise objective functions for discharge, evapotranspiration and tws
    ! OF = sqrt(power2_nse_lnnse(Q)**2 + RMSE(z-score_TWS_domain_avg)**2 + SPEM(ET)**2)
    objective_nse_lnnse_q_rmse_tws_spem_et  = sqrt(objective_q**2 + rmse_tws_avg**2 + & 
                                                objective_spem_et**2)
												
    !objective_nse_lnnse_q_rmse_tws_spem_et  = (objective_q**6 + rmse_tws_avg**6 + & 
    !                                            objective_spem_et**6)**onesixth
	
    call message('    objective_nse_lnnse_q (i.e., power2_nse_lnnse) = ', num2str(objective_q, '(F9.5)'))
    call message('                   objective_rmse_tws (i.e., RMSE) = ', num2str(rmse_tws_avg, '(F9.5)'))
    call message('                objective_spem_et (i.e., 1 - SPEM) = ', num2str(objective_spem_et, '(F9.5)'))
    call message('      objective_final_nse_lnnse_q_rmse_tws_spem_et = ', & 
                                                 num2str(objective_nse_lnnse_q_rmse_tws_spem_et, '(F9.5)'))

  END FUNCTION objective_nse_lnnse_q_rmse_tws_spem_et
  ...
  !    NAME
  !        objective_nse_lnnse_q_rmse_tws_spem_sm 

  !    PURPOSE
  !>       \brief Objective function for Q, soil moisture and terrestrial water storage (tws).
			!OF = sqrt(power2_nse_lnnse(Q)**2 + RMSE(z-score_TWS_domain_avg)**2 + SPEM(SM)**2) 
  ...
  FUNCTION objective_nse_lnnse_q_rmse_tws_spem_sm(parameterset, eval)
    ...
    use mo_common_mhm_mrm_variables, only : evalPer
    use mo_errormeasures, only : lnnse, nse, rmse
    use mo_global_variables, only : L1_smObs, L1_twsaObs
    use mo_message, only : message
    use mo_string_utils, only : num2str
    use mo_julian, only : caldat
    use mo_moment, only : mean
    ...
    real(dp) :: objective_nse_lnnse_q_rmse_tws_spem_sm 
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_nse_lnnse_q_rmse_tws_spem_sm : Length of TWS data of domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    !--------------------------------------------
    !! COMBINED OF FOR Q + SM + TWS
    !--------------------------------------------
    ! compromise objective functions for discharge, soil moisture and tws
    ! OF = sqrt(power2_nse_lnnse(Q)**2 + RMSE(z-score_TWS_domain_avg)**2 + SPEM(SM)**2)
    objective_nse_lnnse_q_rmse_tws_spem_sm  = sqrt(objective_q**2 + rmse_tws_avg**2 + & 
                                                objective_spem_sm**2)
												
    !objective_nse_lnnse_q_rmse_tws_spem_sm  = (objective_q**6 + rmse_tws_avg**6 + & 
    !                                            objective_spem_sm**6)**onesixth
	
    call message('    objective_nse_lnnse_q (i.e., power2_nse_lnnse) = ', num2str(objective_q, '(F9.5)'))
    call message('                   objective_rmse_tws (i.e., RMSE) = ', num2str(rmse_tws_avg, '(F9.5)'))
    call message('                objective_spem_sm (i.e., 1 - SPEM) = ', num2str(objective_spem_sm, '(F9.5)'))
    call message('      objective_final_nse_lnnse_q_rmse_tws_spem_sm = ', & 
                                                 num2str(objective_nse_lnnse_q_rmse_tws_spem_sm, '(F9.5)'))

  END FUNCTION objective_nse_lnnse_q_rmse_tws_spem_sm
  ...
  !    NAME
  !        objective_nse_lnnse_q_rmse_tws_spem_et_sm 

  !    PURPOSE
  !>       \brief Objective function for Q, evapotranspiration, soil moisture
            ! and terrestrial water storage (tws).
			!OF = sqrt(power2_nse_lnnse(Q)**2 + RMSE(z-score_TWS_domain_avg)**2 + SPEM(ET)**2 + SPEM(SM)**2) 

  !>       \details ...TO BE COMPLETED.
  !>       \it is assumed that optional data for optimization are monthly data.
  
  ! added by Moctar Dembélé, 07.01.2019
  ! updated for mHM v5.12.1 by Loïc Gerber, 12.2022
  
  FUNCTION objective_nse_lnnse_q_rmse_tws_spem_et_sm(parameterset, eval)
    ...
    real(dp) :: objective_nse_lnnse_q_rmse_tws_spem_et_sm 
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_nse_lnnse_q_rmse_tws_spem_et_sm : Length of TWS data of domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    !--------------------------------------------
    !! COMBINED OF FOR Q + SM + ET + TWS
    !--------------------------------------------
    ! compromise objective functions for discharge, evapotranspiration, soil moisture and tws
    ! OF = sqrt(power2_nse_lnnse(Q)**2 + RMSE(z-score_TWS_domain_avg)**2 + SPEM(ET)**2 + SPEM(SM)**2)
    objective_nse_lnnse_q_rmse_tws_spem_et_sm  = sqrt(objective_q**2 + rmse_tws_avg**2 + & 
                                                objective_spem_et**2 + objective_spem_sm**2)
												
    !objective_nse_lnnse_q_rmse_tws_spem_et_sm  = (objective_q**6 + rmse_tws_avg**6 + & 
    !                                            objective_spem_et**6 + objective_spem_sm**6)**onesixth
    ...
    call message('                objective_spem_et (i.e., 1 - SPEM) = ', num2str(objective_spem_et, '(F9.5)'))
    call message('                objective_spem_sm (i.e., 1 - SPEM) = ', num2str(objective_spem_sm, '(F9.5)'))
    call message('   objective_final_nse_lnnse_q_rmse_tws_spem_et_sm = ', & 
                                                 num2str(objective_nse_lnnse_q_rmse_tws_spem_et_sm, '(F9.5)'))

  END FUNCTION objective_nse_lnnse_q_rmse_tws_spem_et_sm
  ...
  !    NAME
  !        objective_kge_q_rmse_tws_spem_et_sm 

  !    PURPOSE
  !>       \brief Objective function for Q, evapotranspiration, soil moisture
            ! and terrestrial water storage (tws).
			!OF = sqrt(KGE(Q)**2 + RMSE(z-score_TWS_domain_avg)**2 + SPEM(ET)**2 + SPEM(SM)**2) 

  !>       \details ...TO BE COMPLETED.
  !>       \it is assumed that optional data for optimization are monthly data.
  
  ! added by Moctar Dembélé, 24.12.2018
  ! updated for mHM v5.12.1 by Loïc Gerber, 12.2022

  FUNCTION objective_kge_q_rmse_tws_spem_et_sm(parameterset, eval)
    ...
    real(dp) :: objective_kge_q_rmse_tws_spem_et_sm 
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_kge_q_rmse_tws_spem_et_sm : Length of TWS data of domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    ! compromise objective functions for discharge, evapotranspiration, soil moisture and tws
    ! OF = sqrt(KGE(Q)**2 + RMSE(z-score_TWS_domain_avg)**2 + SPEM(ET)**2 + SPEM(SM)**2)
    objective_kge_q_rmse_tws_spem_et_sm  = sqrt(objective_q**2 + rmse_tws_avg**2 + & 
                                                objective_spem_et**2 + objective_spem_sm**2)
												
    !objective_kge_q_rmse_tws_spem_et_sm  = (objective_q**6 + rmse_tws_avg**6 + & 
    !                                            objective_spem_et**6 + objective_spem_sm**6)**onesixth
	
    call message('    objective_kge_q (i.e., power2_nse_lnnse) = ', num2str(objective_q, '(F9.5)'))
    call message('                   objective_rmse_tws (i.e., RMSE) = ', num2str(rmse_tws_avg, '(F9.5)'))
    call message('                objective_spem_et (i.e., 1 - SPEM) = ', num2str(objective_spem_et, '(F9.5)'))
    call message('                objective_spem_sm (i.e., 1 - SPEM) = ', num2str(objective_spem_sm, '(F9.5)'))
    call message('   objective_final_nse_lnnse_q_rmse_tws_spem_et_sm = ', & 
                                                 num2str(objective_kge_q_rmse_tws_spem_et_sm, '(F9.5)'))

  END FUNCTION objective_kge_q_rmse_tws_spem_et_sm
 ...
 ! -----------------------------------------------------------------
  ...
  !    NAME
  !        objective_kge_q_kge_et_catchment_avg 

  !    PURPOSE
  !>       \brief Objective function for Q and evapotranspiration
			!OF = sqrt(kge_q(Q)**2 + KGE(ET_catch_avg)**2) 

  !>       \details ...TO BE COMPLETED.
  !>       \it is assumed that optional data for optimization are monthly data.
  
  ! added by Moctar Dembélé, 26.04.2019
  ! updated for mHM v5.12.1 by Loïc Gerber, 12.2022
  
  FUNCTION objective_kge_q_kge_et_catchment_avg(parameterset, eval)
    ...
    real(dp) :: objective_kge_q_kge_et_catchment_avg
    ...
    do iDomain = 1, domainMeta%nDomains
      ...
      do iTime = 1, size(etOptiSim(iDomain)%dataSim, dim = 2)
        ...
        et_catch_avg_domain(iTime) = average(L1_etObs(iDomain)%dataObs(:, iTime), mask = L1_etObs(iDomain)%maskObs(:, iTime))
        et_opti_catch_avg_domain(iTime) = average(etOptiSim(iDomain)%dataSim(:, iTime), mask = L1_etObs(iDomain)%maskObs(:, iTime))
      end do

      ! calculate average ET KGE over all domains with power law
      ! domains are weighted equally ( 1 / real(nDomain,dp))**6

      objective_et_kge_catchment_avg = objective_et_kge_catchment_avg + &
              ((1.0_dp - kge(et_catch_avg_domain, et_opti_catch_avg_domain, mask = mask_times)) / real(domainMeta%nDomains, dp))**6
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_kge_q_kge_et_catchment_avg : Length of Q data of Domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    ! objective kge Q
    objective_q = 1.0_dp - kge_q_avg

    !--------------------------------------------
    !! COMBINED OF FOR Q + ET
    !--------------------------------------------
    ! compromise objective functions for discharge and evapotranspiration
    ! OF = sqrt(KGE(Q)**2 + KGE(ET_catch_avg)**2)
    objective_kge_q_kge_et_catchment_avg  = sqrt(objective_q**2 + objective_et_kge_catchment_avg**2)

    call message('   objective_kge_q (i.e., kge_q)         = ', num2str(objective_q, '(F9.5)'))
    call message('   objective_et_kge_catchment_avg        = ', num2str(objective_et_kge_catchment_avg, '(F9.5)'))
    call message('   oobjective_kge_q_kge_et_catchment_avg = ', & 
                                                 num2str(objective_kge_q_kge_et_catchment_avg, '(F9.5)'))

  END FUNCTION objective_kge_q_kge_et_catchment_avg
 ...
 ! -----------------------------------------------------------------
  ...
  !    NAME
  !        objective_kge_q_spaceKGE_et 

  !    PURPOSE
  !>       \brief Objective function for Q and evapotranspiration
			!OF = sqrt(kge_q(Q)**2 + KGE(ET)**2) 
  ...
  FUNCTION objective_kge_q_spaceKGE_et(parameterset, eval)
    ...
    real(dp) :: objective_kge_q_spaceKGE_et 
	
    real(dp) :: objective_q
    real(dp) :: objective_kge_et
    real(dp) :: kge_et_avg
    ...
    ! domains wise objectives per time step
    real(dp), dimension(:), allocatable :: kge_time_et

    ! domains wise objectives for each domain	
    real(dp), dimension(:), allocatable :: kge_domain_et
    ...
    allocate(etOptiSim(domainMeta%nDomains))
    call eval(parameterset, runoff = runoff, etOptiSim = etOptiSim)
    print *, 'size(etOptiSim(1)%dataSim, dim = 2) = ', size(etOptiSim(1)%dataSim, dim = 2)

    ! initialize some variables
    allocate(kge_domain_et(domainMeta%nDomains))
    kge_domain_et(:) = nodata_dp
    kge_et_avg = 0.0_dp
    ...
    do iDomain = 1, domainMeta%nDomains
      ...
      ! allocate
      allocate(mask_times (size(etOptiSim(iDomain)%dataSim, dim = 2)))
      allocate(kge_time_et(size(etOptiSim(iDomain)%dataSim, dim = 2)))

      ! init
      mask_times = .TRUE.
      kge_time_et = nodata_dp
	  
      ! --------------------
      !  EVAPOTRANSPIRATION
      ! --------------------
      ! kge is calculated for every time step
      invalid_times = 0.0_dp
      nMonths_et = size(etOptiSim(iDomain)%dataSim, dim = 2)
      ...
      do iTime = 1, nMonths_et
		...
		! Calculate KGE over all cells for every time step										  
        kge_time_et(iTime) = kge(L1_etObs(iDomain)%dataObs(:, iTime), etOptiSim(iDomain)%dataSim(:, iTime), &
                                                  mask = L1_etObs(iDomain)%maskObs(:, iTime))
      end do

      ! user information about invalid times
      if (invalid_times .GT. 0.5_dp) then
        call message('   WARNING: kge_time_et: Detected invalid times in study area (.LT. 10 valid data points).')
        call message('                          Fraction of invalid times: ', &
                num2str(invalid_times / real(nMonths_et, dp), '(F4.2)'))
      end if

	  ! calculate average kge for the domain	
      kge_domain_et(iDomain) = sum(kge_time_et(:), abs(kge_time_et - nodata_dp) .gt. eps_dp) / &
            real(count(abs(kge_time_et - nodata_dp) .gt. eps_dp), dp)
	     
      deallocate(mask_times)
      deallocate(kge_time_et)
    ...
    ! et solution
    objective_kge_et = 0.0_dp
	
    kge_et_avg = sum(kge_domain_et(:), abs(kge_domain_et - nodata_dp) .gt. eps_dp) / &
            real(count(abs(kge_domain_et - nodata_dp) .gt. eps_dp), dp)
			
    objective_kge_et = 1.0_dp - kge_et_avg
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_kge_q_spaceKGE_et : Length of Q data of domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    ! compromise objective functions for discharge and evapotranspiration
    ! OF = sqrt(kge_q(Q)**2 + KGE(ET)**2)
    objective_kge_q_spaceKGE_et  = sqrt(objective_q**2 + objective_kge_et**2)
	
    ! OF = (kge_q(Q)**6 + KGE(ET)**6)**onesixth
    !objective_kge_q_spaceKGE_et  = (objective_q**6 + objective_kge_et**6)**onesixth
	
    call message('   objective_kge_q (i.e., kge_q)     = ', num2str(objective_q, '(F9.5)'))
    call message('   objective_kge_et (i.e., 1 - KGE)  = ', num2str(objective_kge_et, '(F9.5)'))
    call message('   objective_final_kge_q_spaceKGE_et = ', & 
                                                 num2str(objective_kge_q_spaceKGE_et, '(F9.5)'))

  END FUNCTION objective_kge_q_spaceKGE_et
  ...
  !    NAME
  !        objective_kge_q_spem_et 

  !    PURPOSE
  !>       \brief Objective function for Q and evapotranspiration
			!OF = sqrt(kge_q(Q)**2 + SPEM(ET)**2) 
  ...
  FUNCTION objective_kge_q_spem_et(parameterset, eval)
    ...
    real(dp) :: objective_kge_q_spem_et 
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_kge_q_spem_et : Length of Q data of domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    ! compromise objective functions for discharge and evapotranspiration
    ! OF = sqrt(kge_q(Q)**2 + SPEM(ET)**2)
    objective_kge_q_spem_et  = sqrt(objective_q**2 + objective_spem_et**2)
	
    ! OF = (kge_q(Q)**6 + SPEM(ET)**6)**onesixth
    !objective_kge_q_spem_et  = (objective_q**6 + objective_spem_et**6)**onesixth
	
    call message('   objective_kge_q (i.e., kge_q)       = ', num2str(objective_q, '(F9.5)'))
    call message('   objective_spem_et (i.e., 1 - SPEM)  = ', num2str(objective_spem_et, '(F9.5)'))
    call message('   objective_final_kge_q_spem_et       = ', & 
                                                 num2str(objective_kge_q_spem_et, '(F9.5)'))

  END FUNCTION objective_kge_q_spem_et
 ...
 ! -----------------------------------------------------------------
  ...
  !    NAME
  !        objective_timeKGE_et

  !    PURPOSE
  !>       \brief Objective function for Q and evapotranspiration
			!OF = KGE(ET), !KGE for each pixel, and average KGE of all pixels  
  ...
  FUNCTION objective_timeKGE_et(parameterset, eval)
    ...
    do iDomain = 1, domainMeta%nDomains
      ...
      do iCell = 1, size(L1_etObs(iDomain)%maskObs(:, :), dim = 1)
        ...
        ! check for enough data points in time for statistical calculations (e.g. mean, stddev)
        if (count(L1_etObs(iDomain)%maskObs(iCell, :)) .LE. 0.10_dp * real(size(L1_etObs(iDomain)%dataObs(:, :), dim = 2), dp)) then
          invalid_cells = invalid_cells + 1.0_dp
          cycle
        end if
    ...
    ! compromise solution - sixth root
    objective_et = objective_et**onesixth
    objective_timeKGE_et = objective_et

    call message('    objective_timeKGE_et = ', num2str(objective_timeKGE_et, '(F9.5)'))

  END FUNCTION objective_timeKGE_et
 ...
 ! -----------------------------------------------------------------
  ...
  FUNCTION objective_spaceKGE_et(parameterset, eval)
	...
	! et solution
    objective_spaceKGE_et = 0.0_dp
	
    kge_et_avg = sum(kge_domain_et(:), abs(kge_domain_et - nodata_dp) .gt. eps_dp) / &
            real(count(abs(kge_domain_et - nodata_dp) .gt. eps_dp), dp)
			
    objective_spaceKGE_et = 1.0_dp - kge_et_avg
  ...
  FUNCTION objective_spem_et(parameterset, eval)
  ...
  END FUNCTION objective_spem_et
  ...
  ! added by Loïc Gerber, 01.2023
  
  FUNCTION objective_spem_sm(parameterset, eval)
  ...
  END FUNCTION objective_spem_sm
  ...
  !    PURPOSE
  !>       \brief Objective function for terestrial water storage
			!OF = SPEM(ET)**2
  ...
  FUNCTION objective_spem_twsa(parameterset, eval)
    ...
    ! run mHM
    call eval(parameterset, twsOptiSim = twsOptiSim)
  ...
  END FUNCTION objective_spem_twsa
  ...
  !    NAME
  !        objective_nse_lnnse_q_spem_twsa_et_sm 

  !    PURPOSE
  !>       \brief Objective function for Q, evapotranspiration, soil moisture
            ! and terrestrial water storage anomaly (twsa).
			!OF = sqrt(power2_nse_lnnse(Q)**2 + SPEM(TWSA)**2 + SPEM(ET)**2 + SPEM(SM)**2) 
  ...
  FUNCTION objective_nse_lnnse_q_spem_twsa_et_sm(parameterset, eval)
    ...
    real(dp) :: objective_nse_lnnse_q_spem_twsa_et_sm
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_nse_lnnse_q_spem_twsa_et_sm : Length of Q data of domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    !--------------------------------------------
    !! COMBINED OF FOR Q + SM + ET + TWSA
    !--------------------------------------------
    ! compromise objective functions for discharge, evapotranspiration, soil moisture and twsa
    ! OF = sqrt(power2_nse_lnnse(Q)**2 + SPEM(TWSA)**2 + SPEM(ET)**2 + SPEM(SM)**2)
    objective_nse_lnnse_q_spem_twsa_et_sm  = sqrt(objective_q**2 + objective_spem_twsa**2 + & 
                                                objective_spem_et**2 + objective_spem_sm**2)
    ...
    call message('                objective_spem_et (i.e., 1 - SPEM) = ', num2str(objective_spem_et, '(F9.5)'))
    call message('                objective_spem_sm (i.e., 1 - SPEM) = ', num2str(objective_spem_sm, '(F9.5)'))
    call message('       objective_final_nse_lnnse_q_spem_twsa_et_sm = ', & 
                                                 num2str(objective_nse_lnnse_q_spem_twsa_et_sm, '(F9.5)'))

  END FUNCTION objective_nse_lnnse_q_spem_twsa_et_sm
  ...
  !    NAME
  !        objective_kge_q_spem_twsa_et_sm 

  !    PURPOSE
  !>       \brief Objective function for Q, evapotranspiration, soil moisture
            ! and terrestrial water storage anomaly (twsa).
			!OF = sqrt(KGE(Q)**2 + SPEM(TWSA)**2 + SPEM(ET)**2 + SPEM(SM)**2) 
  ...
  FUNCTION objective_kge_q_spem_twsa_et_sm(parameterset, eval)
    ...
    real(dp) :: objective_kge_q_spem_twsa_et_sm 
    ...
    do gg = 1, nGaugesTotal
      ...
      pp = count(runoff_agg .ge. 0.0_dp)
      if (pp .lt.  365 * 2) then
        call message('objective_kge_q_spem_twsa_et_sm : Length of Q data of domain ', trim(adjustl(num2str(iDomain))), &
        ' less than 2 years: this is not recommended')
      end if
    ...
    ! compromise objective functions for discharge, evapotranspiration, soil moisture and twsa
    ! OF = sqrt(KGE(Q)**2 + SPEM(TWSA)**2 + SPEM(ET)**2 + SPEM(SM)**2)
    objective_kge_q_spem_twsa_et_sm  = sqrt(objective_q**2 + objective_spem_twsa**2 + & 
                                                objective_spem_et**2 + objective_spem_sm**2)
    ...
    call message('          objective_spem_et (i.e., 1 - SPEM) = ', num2str(objective_spem_et, '(F9.5)'))
    call message('          objective_spem_sm (i.e., 1 - SPEM) = ', num2str(objective_spem_sm, '(F9.5)'))
    call message('       objective_final_kge_q_spem_twsa_et_sm = ', & 
